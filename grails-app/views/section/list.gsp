				...
				<table class="table table-striped">
					<thead>
						<tr>
							...
							<g:sortableColumn property="building" title="${message(code: 'section.building.label', default: 'Building')}" />
							...
							<g:sortableColumn property="schedule" title="${message(code: 'section.schedule.label', default: 'Schedule')}" />
						
							<g:sortableColumn property="sectionNumber" title="${message(code: 'section.sectionNumber.label', default: 'Section Number')}" />
