				...
				<dl>
					...
					<g:if test="${sectionInstance?.course}">
						<dt><g:message code="section.course.label" default="Course" /></dt>
							...
							<dd><g:link controller="course" action="show" id="${sectionInstance?.course?.id}">${sectionInstance?.course?.encodeAsHTML()}</g:link></dd>
					...
					<g:if test="${sectionInstance?.students}">
						<dt><g:message code="section.students.label" default="Students" /></dt>
							...
							<dd><g:link controller="user" action="show" id="${s.id}">${s?.encodeAsHTML()}</g:link></dd>
							</g:each>
					...
					<g:if test="${sectionInstance?.teacher}">
						<dt><g:message code="section.teacher.label" default="Teacher" /></dt>
							...
							<dd><g:link controller="user" action="show" id="${sectionInstance?.teacher?.id}">${sectionInstance?.teacher?.encodeAsHTML()}</g:link></dd>
