...
<div class="fieldcontain ${hasErrors(bean: gradesInstance, field: 'assignment', 'error')} required">
    <label for="assignment">
        <g:message code="grades.assignment.label" default="Assignment"/>
        <span class="required-indicator">*</span>
    </label>
    <g:select id="assignment" name="assignment.id" from="${school.Assignment.list()}" optionKey="id" required=""
...
<div class="fieldcontain ${hasErrors(bean: gradesInstance, field: 'grade', 'error')} ">
    <label for="grade">
        <g:message code="grades.grade.label" default="Grade"/>
...
<div class="fieldcontain ${hasErrors(bean: gradesInstance, field: 'students', 'error')} required">
    <label for="students">
        <g:message code="grades.students.label" default="Students"/>
        <span class="required-indicator">*</span>
    </label>
